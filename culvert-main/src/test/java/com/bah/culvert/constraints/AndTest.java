...
public class AndTest {
	 ...
	 * 
	 * Passage of this test indicates that the system can handle an empty
	 * iterator from a Constraint which may occur if the result set of a
	 * Constraint is blank
	 */
	@Test
  ...
  public void testWriteAnd() throws Exception {
	...
	public void testToString() {
		...
		And myand = new And(myconstraint1, myconstraint2);
		Assert.assertEquals("And([EasyMock for class com.bah.culvert.constraints.Constraint,EasyMock for class com.bah.culvert.constraints.Constraint])", 
							myand.toString());
	}	
	 ...
	 * 
	 * Finds out the number of elements that will be returned with And from
	 * Anding the list of sets given. Each individual set is sorted in this
