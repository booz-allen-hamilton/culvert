...
public class TestResult {
  ...
  public void testGetValues() throws Throwable {
    ...
    Assert.assertArrayEquals(new byte[] { 4 }, result.getValue(
        new byte[] { 2 }, new byte[] { 3 }).getValue());
    Assert.assertArrayEquals(new byte[] { 4, 1 }, result.getValue(
        new byte[] { 2 }, new byte[] { 5 }).getValue());
    Assert.assertArrayEquals(new byte[] { 4 }, result.getValue(
        new byte[] { 6 }, new byte[] { 5 }).getValue());
    Assert.assertArrayEquals(new byte[] { 4 }, result.getValue(
        new byte[] { 2 }, new byte[] { 3 }).getValue());
    Assert.assertEquals(null, result.getValue(new byte[] { 2 },
        new byte[] { 2 }));
  }
}
