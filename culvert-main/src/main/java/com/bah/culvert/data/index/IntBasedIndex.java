...
/**
 * Creates an index based on integer values to allow for sorting. Just stores the binary value, 
 ...
 * 
 */
public class IntBasedIndex extends Index {

  private static final Log LOG = LogFactory.getLog(IntBasedIndex.class);
   ...
   * @param indexTable
   */
  public IntBasedIndex(String name, DatabaseAdapter database,
  ...
  public SeekingCurrentIterator handleGet(byte[] indexRangeStart,
    ...
    return new IntBasedIndexIterator(indexTable.get(get));
  }
   ...
   * 
   */
  public static class IntBasedIndexIterator extends DecoratingCurrentIterator {

    public IntBasedIndexIterator(SeekingCurrentIterator iterator) {
      super(iterator);
    }
    ...
    public Result next() {
      ...
      byte[] dataRowId = IntBasedIndex.parseIndexRowGetId(indexRowId);
